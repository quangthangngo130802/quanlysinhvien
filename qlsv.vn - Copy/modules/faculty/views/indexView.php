...
<script src="public/js/a.department/delete_faculty.js"></script>

<script src="public/js/a.department/department.js"></script>
        ...
        <div id="content" class="fl-right" style="padding: 20px 8px;">
            <div class="section" id="title-page">
                <div class="clearfix">
                    ...
                    <a href="?mod=faculty&action=add" title="" id="add-new" class="fl-left">Thêm mới</a>
                </div>
            </div>
            <div class="section" id="detail-page">
                <div class="section-detail">
                    ...
                    <div class="table-responsive" id="list_faculty">
                       
                    </div>
                    <div class="section" id="paging_faculty" style="text-align: center;">
