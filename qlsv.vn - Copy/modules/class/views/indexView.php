...
<script src="public/js/a.class/class.js"></script>
        ...
        <div id="content" class="fl-right" style="padding: 20px 8px;">
            <div class="section" id="title-page">
                <div class="clearfix">
                    ...
                    <a href="?mod=class&action=add" title="" id="add-new" class="fl-left">Thêm mới</a>
                </div>
            </div>
            <div class="section" id="detail-page">
                <div class="section-detail">
                    ...
                    <div class="table-responsive" id="list_class">
                       
                    </div>
                    <div class="section" id="paging_class" style="text-align: center;">
